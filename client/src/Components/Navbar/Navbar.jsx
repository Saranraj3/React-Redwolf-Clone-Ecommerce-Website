...
const Navbar = ({ user }) => {
  return (
    <div className="sticky top-0 z-10 h-[2.5rem] bg-black text-white overflow-y-hidden overflow-x-hidden">
      <p className="sm:text-center sm:font-extrabold sm:text-2xl sm:h-10 sm:pt-1 lg:invisible relative bg-Red text-white font-extrabold ">
        REDWOLF
      </p>
      <div className=" sm:left-0 absolute">
        <img
          className="lg:invisible sm:mt-[-2.4rem] sm:ml-4  sm:h-8 sm:w-8  "
          src={smmenu}
          alt=""
        />
      </div>
      ...
      <nav className="lg:mt-[-2.5rem] lg:visible sm:invisible flex">
        <p className="xl:w-[11rem] lg:h-[3rem] lg:w-[11rem] lg:pt-1 lg:text-2xl lg:text-center font-extrabold text-white bg-Red">
          𝑅𝐸𝒟𝒲𝒪𝐿𝐹
        </p>
        <img
          className="xl:ml-[-9.5rem] lg:w-[8rem] lg:h-9 lg:ml-[-9.2rem] opacity-0 transition-opacity duration-300 transform hover:opacity-100 cursor-pointer "
          src={redwolftitlegif}
          alt=""
        />
        <ul className="xl:ml-[3rem] xl:gap-4 xl:text-sm lg:ml-8 lg:mt-3 lg:gap-1 lg:text-xs font-extrabold flex">
          <li className=" cursor-pointer flex hover:text-Red">
            SHOP
            <RiArrowDropDownLine className="lg:h-7 lg:w-7" />
          </li>
          <li className=" cursor-pointer flex hover:text-Red">
            MEN
            <RiArrowDropDownLine className="lg:h-7 lg:w-7" />
          ...
          <li className=" cursor-pointer xl:visible lg:invisible flex hover:text-Red">
            ACCESSORIES
            <RiArrowDropDownLine className="lg:h-7 lg:w-7" />
          </li>
          <li className=" cursor-pointer xl:ml-0 lg:ml-[-7.3rem] flex hover:text-Red">
            CHARACTERS
            <RiArrowDropDownLine className="lg:h-7 lg:w-7" />
          </li>
          <li className=" cursor-pointer flex hover:text-Red">
        ...
        <div className="relative xl:ml-4 lg:mt-[-0.5rem] items-center flex">
          ...
          <input
            className="xl:w-[13rem] xl:text-sm lg:h-[2rem] lg:w-[11rem] lg:pl-[2rem] lg:text-xs border border-bordergray placeholder-gray-500 bg-backgroundgray cursor-pointer rounded-md "
            type="search"
            placeholder="Search for Products,Shows Or Characters"
          />
        </div>
