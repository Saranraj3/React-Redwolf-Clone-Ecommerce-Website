        ...
        <div>
            ...
            <form>
                <div className='text-center mt-5'>
                    ...
                    <input className='pl-3 font-light w-[32rem] h-8 rounded-md placeholder-footercolor border border-gray-300' type="text" name='Fast Name' placeholder='Fast Name ' />
                </div>
                <div className='text-center mt-5'>
                    <label className='mr-[4rem] text-footercolor text-sm' htmlFor="Last Name">Last Name</label>
                    <input className='pl-3 font-light w-[32rem] h-8 rounded-md placeholder-footercolor border border-gray-300' type="text" name='Last Name' placeholder='Last Name' />
                </div>
                <div className='text-center mt-5'>
                    <label className='mr-[5.7rem] text-footercolor text-sm' htmlFor="Email">E-mail</label>
                   <input className='pl-3 font-light w-[32rem] h-8 rounded-md placeholder-footercolor border border-gray-300' type="email" name='Email' placeholder='E-mail' />
                </div>

                <div className='text-center mt-5'>
                    <label className='mr-[4rem] text-footercolor text-sm' htmlFor="password">Password</label>
                    <input className='pl-3 font-light w-[32rem] h-8 rounded-md placeholder-footercolor border border-gray-300' type="password" name='password' placeholder='Password' />
                </div>
                <div className='text-center mt-5'>
                    <label className='mr-3 text-footercolor text-sm' htmlFor="confirm password">Confirm Password</label>
                    <input className=' pl-3 font-light w-[32rem] h-8 rounded-md placeholder-footercolor border border-gray-300' type="password" name='confirm password' placeholder='Confirm Password' />
                </div>
                <div className='text-center mt-5'>
                    <label className='ml-[-25rem] text-footercolor text-sm' htmlFor="newsletter">Subscribe to Newsletter</label>
                    <input className='ml-4 accent-Red' type="radio" name='newsletter' placeholder='' />
                    <label className=' mr-4 text-footercolor text-sm' htmlFor="">Yes</label>
                    <input className='accent-Red' type="radio" name='newsletter' placeholder='' />
